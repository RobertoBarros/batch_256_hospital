class Router
  ...
  def initialize(patients_controller, rooms_controller, doctors_controller, appointment_controller)
  ...
  def dispatch(action)
    ...
    when 7 then @appointment_controller.create
    when 8 then @appointment_controller.list
